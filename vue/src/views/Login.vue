      ...
      <div class="bg-danger" >
        ...
        <div style="height:400px;background:url(http://static.wdmcake.cn/themes/wdm/images/main.png) no-repeat" class="mt-5">
          <div class="bg-white" style="width:340px;height:360px;margin-left:800px;padding:50px">
            <div>
              <h4 style="font-size:14px" class=""><strong>会员登陆</strong></h4>
              ...
              <input style="width:250px;height:30px;padding:10px;margin:10px 0"  type="password" placeholder="请输入密码" v-model="password" @blur="checkpassword">


              <button class="btn-danger" style="width:250px;height:30px;font-size:13px" @click="handle()">登陆</button>
              <div style="font-size:14px"><a href="/register">没有账号？立即注册</a></div>
              <p style="font-size:14px;margin-top:30px">温馨提示：<br>
...
export default {
  ...
  methods:{
    ...
    //2.再校验密码是否合法,规则为：字母、数字及下划线额组合，长度8~20
    checkpassword(){
